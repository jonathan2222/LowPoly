...
yami::Shader::Shader(const std::string & pathName)
{
	init(pathName, VERTEX_SHADER | FRAGMENT_SHADER);
}

yami::Shader::Shader(const std::string & pathName, unsigned int flags)
{
	init(pathName, flags);
}
...
void yami::Shader::bind()
{
	glUseProgram(this->id);
}

void yami::Shader::unbind()
{
	glUseProgram(0);
}

void yami::Shader::setTexture2D(const std::string & name, unsigned int unit)
{
	glUniform1i(addUniform(name), unit);
}

void yami::Shader::setTexture2D(const std::string & name, unsigned int unit, GLuint textureID)
{
...
void yami::Shader::setUniform1i(const std::string & name, int value)
{
	glUniform1i(addUniform(name), value);
}

void yami::Shader::setUniform1b(const std::string & name, bool value)
{
	setUniform1i(name, (int)value);
}

void yami::Shader::setUniform1f(const std::string & name, float v1)
{
	glUniform1f(addUniform(name), v1);
}

void yami::Shader::setUniform2f(const std::string & name, float v1, float v2)
{
	glUniform2f(addUniform(name), v1, v2);
}

void yami::Shader::setUniform2fv(const std::string & name, unsigned int count, const float * values)
{
	glUniform2fv(addUniform(name), count, values);
}

void yami::Shader::setUniform3f(const std::string & name, float v1, float v2, float v3)
{
	glUniform3f(addUniform(name), v1, v2, v3);
}

void yami::Shader::setUniform3fv(const std::string & name, unsigned int count, const float * values)
{
	glUniform3fv(addUniform(name), count, values);
}

void yami::Shader::setUniform4f(const std::string & name, float v1, float v2, float v3, float v4)
{
	glUniform4f(addUniform(name), v1, v2, v3, v4);
}

void yami::Shader::setUniform4fv(const std::string & name, unsigned int count, const float * values)
{
	glUniform4fv(addUniform(name), count, values);
}

void yami::Shader::setUniformMatrix4fv(const std::string & name, unsigned int count, bool transpose, const float * values)
{
	glUniformMatrix4fv(addUniform(name), count, transpose, values);
}

const GLuint yami::Shader::getID() const
{
	return this->id;
}

void yami::Shader::init(const std::string & pathName, unsigned int flags)
{
...
int yami::Shader::addUniform(const std::string & name)
{
...
void yami::Shader::addShaderpart(const std::string & pathName, GLuint type)
{
...
GLuint yami::Shader::loadShaderPart(const std::string & pathName, GLuint type)
{
...
bool yami::Shader::compileShaderPart(GLuint id)
{
	char buff[1024];
	memset(buff, 0, 1024);
