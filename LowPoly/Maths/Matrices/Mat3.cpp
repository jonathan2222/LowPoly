...
yami::Mat3::Mat3(const Vec3 & col1, const Vec3 & col2, const Vec3 & col3)
{
	this->col[0] = col1;
	this->col[1] = col2;
	this->col[2] = col3;
...
yami::Mat3::Mat3(float e11, float e12, float e13, float e21, float e22, float e23, float e31, float e32, float e33)
{
...
yami::Mat3::Mat3(const Mat3 & m)
{
	copy(m);
}

yami::Mat3::Mat3(const Mat2 & m)
{
...
yami::Vec3 & yami::Mat3::operator[](size_t i)
{
	return getColumn(i);
}

const yami::Vec3 & yami::Mat3::operator[](size_t i) const
{
	return getColumn(i);
}

yami::Vec3 yami::Mat3::getRow(size_t i) const
{
	return Vec3(this->col[0][i], this->col[1][i], this->col[2][i]);
}

yami::Vec3 & yami::Mat3::getColumn(size_t i)
{
	return this->col[i];
}

const yami::Vec3 & yami::Mat3::getColumn(size_t i) const
{
	return this->col[i];
}

yami::Mat3 & yami::Mat3::operator=(const Mat3 & m)
{
	return copy(m);
}
...
yami::Mat3 & yami::Mat3::operator*=(float scalar)
{
...
yami::Mat3 yami::Mat3::operator*(const Mat3 & m) const
{
	Mat3 ret;
	for (size_t r = 0; r < 3; r++)
		for (size_t c = 0; c < 3; c++)
...
yami::Vec3 yami::Mat3::operator*(const Vec3 & v) const
{
	Vec3 ret;
	for (size_t r = 0; r < 3; r++)
...
yami::Mat3 yami::Mat3::operator*(float scalar) const
{
	Mat3 m(*this);
	return m *= scalar;
}

int yami::Mat3::getSideLength() const
{
	return 3;
}

yami::Mat3 & yami::Mat3::copy(const Mat3 & m)
{
	for (size_t c = 0; c < 3; c++)
		this->col[c] = m[c];
	return *this;
